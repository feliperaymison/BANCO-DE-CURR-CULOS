...
<center>
  <a href="identificaAluno.php">
    <div class="card" style=" margin-top: 1.8%;">
      <button type="button"  class="vituriano btn btn-success botao">Novo Perfil</button>
    </div>
  </a>


  <a href="LoginEstudanteUpdate.php">
    <div class="card" style=" margin-top: 1.8%;">
  ...
  <a href="#">
    <div class="card" style=" margin-top: 1.8%;">
      <button type="button" class="vituriano btn btn-success botao">Vagas (em breve)</button>
    </div>
  </a>

  <a href="LoginEstudanteToCurriculo.php" >
    <div class="card" style=" margin-top: 1.8%;">
...
echo "# BancoCurriculos" >> README.md
git init
git add README.md
git commit -m "first commit"
git remote add origin https://github.com/MariaLhu/BancoCurriculos.git
