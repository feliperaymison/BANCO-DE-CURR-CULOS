      ...
      <div class="mdl-layout__header-row">
        ...
        <span class="mdl-layout-title" style="color: white;">Página de Identificação</span>
            ...
            <div class="mdl-card mdl-shadow--6dp">
              ...
              <form action="validarAluno.php" method="POST">
              ...
              <div class="mdl-card__actions mdl-card--border">
                <div class="mdl-grid">
                  <button class="mdl-cell mdl-cell--12-col mdl-button mdl-button--raised mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-color-text--white" type="submit" id="validar" name="validar">Validar</button>
                </div>
              </div>
              </form>
            </div>
