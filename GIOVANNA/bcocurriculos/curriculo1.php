    ...
    printf("<div class='mdl-layout mdl-js-layout mdl-layout--fixed-header'>
        <header class='mdl-layout__header'>
            <div class='mdl-layout__header-row'>
        		...
        		<span class='mdl-layout-title' style='color:green;'>Meu Currículo</span>
            </div>
        </header>
	<div>
	<table>
      ...
      <td><img src='http://issct2013.com.br/wp-content/uploads/2018/04/curriculo-1.jpg' style='position: fixed;width:10em; height:11em;'></td>
        	</div>
        	<!--- card dos textos --->
